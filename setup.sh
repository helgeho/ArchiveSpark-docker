...
if [ ! -d /config/lib ]; then
    mkdir /config/lib
    curl -L -O https://github.com/helgeho/ArchiveSpark/releases/download/v2.7/archivespark-assembly-2.7.jar
    curl -L -O https://github.com/helgeho/ArchiveSpark/releases/download/v2.7/archivespark-assembly-2.7-deps.jar
    mv archivespark-assembly-2.7.jar /config/lib
    mv archivespark-assembly-2.7-deps.jar /config/lib
fi
